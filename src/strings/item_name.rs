...
pub fn get() -> HashMap<&'static str, &'static str> {
    vec![
        ...
        ("HeavyWorkBench", "Heavy Assembler"),
        ...
        (
            ...
            "Martian Brain Scrambler Banner",
        ),
        ...
        ("KiteBunnyCrimson", "Vicious Bunny Kite"),
        ...
        (
            ...
            "Guide to Critter Companionship (Inactive)",
        ),
        (
        ...
        (
            ...
            "Guide to Peaceful Coexistence (Inactive)",
        ),
        ("DeadCellsMushroomBoiSummonItem", "Mushroom Staff"),
        ("DeadCellsBeheadedHead", "The Beheaded's Head"),
        ("DeadCellsBeheadedBody", "The Beheaded's Cuirass"),
        ("DeadCellsBeheadedLegs", "The Beheaded's Trousers"),
        ("DeadCellsBarrelLauncher", "Barrel Launcher"),
        ("DeadCellsKillingDeck", "Killing Deck"),
        ("DeadCellsFlint", "Flint"),
        ("DeadCellsBarnacleSummonItem", "Barnacle Staff"),
        ("MiteyTitey", "Mitey-Titey"),
        ("DeadCellsRamRune", "Ram Rune"),
        ("DeadCellsSwarmGrenade", "Swarm Grenade"),
        ("DemonAltarReplica", "Replica Demon Altar"),
        ("CrimsonAltarReplica", "Replica Crimson Altar"),
        ("ShadowOrbReplica", "Replica Shadow Orb"),
        ("CrimsonHeartReplica", "Replica Crimson Heart"),
        ("CobwebReplica", "Decorative Cobweb"),
        ("DeadCellsDisplayJar", "Item Flask"),
        ("QueenOfBees", "Queen of Bees"),
        ("DeadCellsPotionStation", "Alchemy Flask"),
        ("PortableKiln", "Portable Kiln"),
        ("CobWhip", "Cobwhip"),
        ...
        ("TheSeaOfSilence", "The Sea of Silence"),
        ("HeroesFromAnotherWorld", "Heroes From Another World"),
        ("Crystallize", "Crystallize"),
        ("EaterOfLife", "Eater Of Life"),
        ("ThisIsCanonNow", "This Is Canon Now"),
        ("WinterAtVaringskollen", "Winter At Varingskollen"),
        ("MagicShimmerDropper", "Magic Shimmer Dropper"),
        ("ShimmerFallBlock", "Shimmerfall Block"),
        ("ShimmerFallWall", "Shimmerfall Wall"),
        ("ShimmerGun", "Shimmer Gun"),
        ("LifeFruitHealingPotion", "Jungle Juice"),
        ("PinkBanner", "Pink Banner"),
        ("WhiteBanner", "White Banner"),
        ("Pufferfish", "Pufferfish"),
        ("PufferfishCage", "Pufferfish Cage"),
        ("PufferfishPet", "Puffer Shrimp"),
        ("PlayerVoiceFrogItem", "Froggy Neckband"),
        ("PlayerVoiceGoatItem", "Goat's Tuft"),
        ("PlayerVoiceRetroItem", "Old Companion Locket"),
        ("PlayerVoiceCatItem", "Cat Chime"),
        ("PlayerVoiceDogItem", "Dog Collar"),
        ("PlayerVoiceTurkeyItem", "Turkey Wattle Necklace"),
        ("PlayerVoiceGoblinItem", "Mean Goblin's Spikes"),
        ("PlayerVoiceCrowItem", "Crow's Beak"),
        ("PlayerVoiceBalloonItem", "Balloony Beads"),
        ("PlayerVoiceUndeadItem", "Grim Old Barb"),
        ("PlayerVoiceVampireItem", "Vampire Pendant"),
        ("PlayerVoiceCowbellItem", "Cow Bell"),
        ("PlayerVoiceChickenFeetItem", "Chicken Charm"),
        ("RainbowBoulder", "Rainbow Boulder"),
        ("VelociraptorMountItem", "Slasher's Mysterious Skull"),
        ("MoonLordBody", "Moon Lord Torso"),
        ("Poulder", "Poo Boulder"),
        ("Axearang", "Axearang"),
        ("LavaBoulder", "Lava Boulder"),
        ("SpiderBoulder", "Spider Boulder"),
        ("Ghoulder", "Ghoulder"),
        ("ChlorophyteVisor", "Chlorophyte Visor"),
        ("SuperFertilizer", "Infused Fertilizer"),
        ("FlaironFlail", "Flairon"),
        ("OfSeaAndDreams", "Of Sea and Dreams"),
        ("TheRunicPixie", "The Runic Pixie"),
        ("BannerOfTheBeast", "Banner of the Beast"),
        ("StickmanVsTerrTerr", "Stickman vs Terr Terr"),
        ("CozyWindow", "Cozy Window"),
        ("DemonAltar", "Demon Altar"),
        ("CrimsonAltar", "Crimson Altar"),
        ("PlayerVoiceFairyItem", "Fairy Choker"),
        ("PinkPhaseblade", "Pink Phaseblade"),
        ("PinkPhasesaber", "Pink Phasesaber"),
        ("BlackenedFish", "Blackened Fish"),
        ("MagicString", "Magic String"),
        ("MagicYoyoBag", "Magic Yoyo Bag"),
        ("FreezeBomb", "Freeze Bomb"),
        ("StressBall", "Stress Ball"),
        ("CloudPlatform", "Cloud Platform"),
        ("LivingWoodWallUnsafe", "Overgrown Living Wood Wall"),
        ("DirtWallUnsafe", "Natural Dirt Wall"),
        ("StrungCounterweight", "Strung Counterweight"),
        ("LavaCloud", "Lava Cloud"),
        ("StarCloud", "Star Cloud"),
        ("RainbowCloud", "Rainbow Cloud"),
        ("AetheriumBathtub", "Aetherium Bathtub"),
        ("AetheriumBed", "Aetherium Bed"),
        ("AetheriumBookcase", "Aetherium Bookcase"),
        ("AetheriumDresser", "Aetherium Dresser"),
        ("AetheriumCandelabra", "Aetherium Candelabra"),
        ("AetheriumCandle", "Aetherium Candle"),
        ("AetheriumChair", "Aetherium Chair"),
        ("AetheriumChandelier", "Aetherium Chandelier"),
        ("AetheriumChest", "Aetherium Chest"),
        ("AetheriumClock", "Aetherium Clock"),
        ("AetheriumDoor", "Aetherium Door"),
        ("AetheriumLamp", "Aetherium Lamp"),
        ("AetheriumLantern", "Aetherium Lantern"),
        ("AetheriumPiano", "Aetherium Piano"),
        ("AetheriumPlatform", "Aetherium Platform"),
        ("AetheriumSink", "Aetherium Sink"),
        ("AetheriumSofa", "Aetherium Sofa"),
        ("AetheriumTable", "Aetherium Table"),
        ("AetheriumWorkbench", "Aetherium Work Bench"),
        ("Fake_AetheriumChest", "Trapped Aetherium Chest"),
        ("AetheriumToilet", "Aetherium Toilet"),
        ("AxeFairyPetItem", "Faecorn"),
        ("MudBallPlayer", "Mud Ball"),
        ("TorchGodPotion", "Torch God's Flavor"),
        ("LuckyClover", "Lucky Clover"),
        ("WiltedClover", "Wilted Clover"),
        ("RavenFeather", "Raven Feather"),
        ("PrettyMirror", "Pretty Mirror"),
        ("MusicBoxKingSlime", "Music Box (King Slime)"),
        ("MusicBoxQueenBee", "Music Box (Queen Bee)"),
        ("MusicBoxQueenBeeAlt", "Music Box (Alt Queen Bee)"),
        ("MusicBoxLunaticCultist", "Music Box (Lunatic Cultist)"),
        ("MusicBoxTwins", "Music Box (The Twins)"),
        ("MusicBoxSkeletronPrime", "Music Box (Skeletron Prime)"),
        ("MusicBoxDestroyer", "Music Box (The Destroyer)"),
        ("ChickenBonesWings", "Chicken Bones' Wings"),
        ("ChickenBonesHead", "Chicken Bones' Visor"),
        ("ChickenBonesBody", "Chicken Bones' Vest"),
        ("ChickenBonesLegs", "Chicken Bones' Pants"),
        ("ChickenBonesRobe", "Chicken Bones' Robe"),
        ("WeldingMask", "Welding Mask"),
        ("CRTMonolith", "CRT Monolith"),
        ("RetroMonolith", "Retro Monolith"),
        ("BatMountItem", "Amulet of the Night"),
        ("FallenStarBathtub", "Fallen Star Bathtub"),
        ("FallenStarBed", "Fallen Star Bed"),
        ("FallenStarBookcase", "Fallen Star Bookcase"),
        ("FallenStarDresser", "Fallen Star Dresser"),
        ("FallenStarCandelabra", "Fallen Star Candelabra"),
        ("FallenStarCandle", "Fallen Star Candle"),
        ("FallenStarChair", "Fallen Star Chair"),
        ("FallenStarChandelier", "Fallen Star Chandelier"),
        ("FallenStarChest", "Fallen Star Chest"),
        ("FallenStarClock", "Fallen Star Clock"),
        ("FallenStarDoor", "Fallen Star Door"),
        ("FallenStarLamp", "Fallen Star Lamp"),
        ("FallenStarLantern", "Fallen Star Lantern"),
        ("FallenStarPiano", "Fallen Star Piano"),
        ("FallenStarPlatform", "Fallen Star Platform"),
        ("FallenStarSink", "Fallen Star Sink"),
        ("FallenStarSofa", "Fallen Star Sofa"),
        ("FallenStarTable", "Fallen Star Table"),
        ("FallenStarWorkbench", "Fallen Star Work Bench"),
        ("Fake_FallenStarChest", "Trapped Fallen Star Chest"),
        ("FallenStarToilet", "Fallen Star Toilet"),
        ("UpgradedMiningHead", "Prospector Helmet"),
        ("UpgradedMiningBody", "Prospector Shirt"),
        ("UpgradedMiningLegs", "Prospector Pants"),
        ("UpgradedFishingHead", "Captain Hat"),
        ("UpgradedFishingBody", "Captain Vest"),
        ("UpgradedFishingLegs", "Captain Pants"),
        ("FallenStarBlock", "Fallen Star Block"),
        ("FallenStarWall", "Fallen Star Wall"),
        ("RatMountItem", "Cursed Piper Flute"),
        ("ChippysHead", "Chippy's Helmet"),
        ("ChippysBody", "Chippy's Chestplate"),
        ("ChippysLegs", "Chippy's Greaves"),
        ("ChippysWings", "Chippy's Cloak"),
        ("ChippysHeadband", "Chippy's Headband"),
        ("AcornSlingshot", "Acorn Slingshot"),
        ...
        ("MusicBoxEaterOfWorlds", "Music Box (Eater of Worlds)"),
        ("MusicBoxTorchGod", "Music Box (Torch God)"),
        ("MusicBoxTorchGodAlt", "Music Box (Alt Torch God)"),
        ("SuperBomb", "Power Bomb"),
        ("SuperStickyBomb", "Sticky Power Bomb"),
        ("RollerSkatesBlueMountItem", "Blue Roller Skates"),
        ("RollerSkatesGreenMountItem", "Green Roller Skates"),
        ("RollerSkatesClassicMountItem", "Classic Roller Skates"),
        ("RollerSkatesPartyMountItem", "Party Roller Skates"),
        ("RainbowGlowstick", "Rainbow Glowstick"),
        ("ScryingOrb", "Scrying Orb"),
        ("RockCandy", "Rock Candy"),
        ("BlueBikiniBody", "Blue Bikini Top"),
        ("BlueBikiniLegs", "Blue Bikini Bottom"),
        ("RedSwimsuit", "Red Swimsuit"),
        ("GreenSwimshorts", "Green Swimshorts"),
        ("GraySwimshorts", "Gray Swimshorts"),
        ("OrcaBanner", "Orca Banner"),
        ("TeleportationPylonUnderworld", "Underworld Pylon"),
        ("TeleportationPylonShimmer", "Aether Pylon"),
        ("HeroicisHead", "Heroicis' Hat"),
        ("HeroicisBody", "Heroicis' Coat"),
        ("HeroicisLegs", "Heroicis' Pants"),
        ("HeroicisWings", "Heroicis' Wings"),
        ("NoirMonolith", "Film Projector"),
        ("HallowedCrown", "Hallowed Crown"),
        ("HeroicisWingsInactive", "Heroicis' Wings (Inactive)"),
        ("EnchantedPixieDust", "Enchanted Pixie Dust"),
        ("SoundGun", "The Imploder"),
        ("TrueCopperShortsword", "True Copper Shortsword"),
        ("RainbowPhaseblade", "Rainbow Phaseblade"),
        ("RainbowPhasesaber", "Rainbow Phasesaber"),
        ("LibrarianSkeletonBanner", "Librarian Skeleton Banner"),
        ("WaterBoltMimicBanner", "Water Bolt Mimic Banner"),
        ("TeamBlockRedVariant", "Dull Red Team Block"),
        ("TeamBlockGreenVariant", "Dull Green Team Block"),
        ("TeamBlockBlueVariant", "Dull Blue Team Block"),
        ("TeamBlockYellowVariant", "Dull Yellow Team Block"),
        ("TeamBlockPinkVariant", "Dull Pink Team Block"),
        ("TeamBlockWhiteVariant", "Dull White Team Block"),
        ("LilacDuskHead", "Lilac Dusk Hairclip"),
        ("LilacDuskBody", "Lilac Dusk Dress"),
        ("LilacDuskLegs", "Lilac Dusk Skirt"),
        ("BoulderPet", "Friendly Boulder"),
        ("RainbowBoulderPet", "Friendly Rainbow Boulder"),
        ...
        ("SlimeSpear", "Slime Spear"),
        ("SlimeWhip", "Slime Whip"),
        ("FeywoodBathtub", "Feywood Bathtub"),
        ("FeywoodBed", "Feywood Bed"),
        ("FeywoodBookcase", "Feywood Bookcase"),
        ("FeywoodDresser", "Feywood Dresser"),
        ("FeywoodCandelabra", "Feywood Candelabra"),
        ("FeywoodCandle", "Feywood Candle"),
        ("FeywoodChair", "Feywood Chair"),
        ("FeywoodChandelier", "Feywood Chandelier"),
        ("FeywoodChest", "Feywood Chest"),
        ("FeywoodClock", "Feywood Clock"),
        ("FeywoodDoor", "Feywood Door"),
        ("FeywoodLamp", "Feywood Lamp"),
        ("FeywoodLantern", "Feywood Lantern"),
        ("FeywoodPiano", "Feywood Piano"),
        ("FeywoodPlatform", "Feywood Platform"),
        ("FeywoodSink", "Feywood Sink"),
        ("FeywoodSofa", "Feywood Sofa"),
        ("FeywoodTable", "Feywood Table"),
        ("FeywoodWorkbench", "Feywood Work Bench"),
        ("Fake_FeywoodChest", "Trapped Feywood Chest"),
        ("FeywoodToilet", "Feywood Toilet"),
        ("Feywood", "Feywood"),
        ("FeywoodWall", "Feywood Wall"),
        ("HallowedBathtub", "Hallowed Bathtub"),
        ("HallowedBed", "Hallowed Bed"),
        ("HallowedBookcase", "Hallowed Bookcase"),
        ("HallowedDresser", "Hallowed Dresser"),
        ("HallowedCandelabra", "Hallowed Candelabra"),
        ("HallowedCandle", "Hallowed Candle"),
        ("HallowedChair", "Hallowed Chair"),
        ("HallowedChandelier", "Hallowed Chandelier"),
        ("HallowedFurnitureChest", "Fancy Hallowed Chest"),
        ("HallowedClock", "Hallowed Clock"),
        ("HallowedDoor", "Hallowed Door"),
        ("HallowedLamp", "Hallowed Lamp"),
        ("HallowedLantern", "Hallowed Lantern"),
        ("HallowedPiano", "Hallowed Piano"),
        ("HallowedPlatform", "Hallowed Platform"),
        ("HallowedSink", "Hallowed Sink"),
        ("HallowedSofa", "Hallowed Sofa"),
        ("HallowedTable", "Hallowed Table"),
        ("HallowedWorkbench", "Hallowed Work Bench"),
        (
            "Fake_HallowedFurnitureChest",
            "Trapped Fancy Hallowed Chest",
        ),
        ("HallowedToilet", "Hallowed Toilet"),
        ("Hallowed", "Hallowed Brick"),
        ("HallowedWall", "Hallowed Brick Wall"),
        ("PalworldPalMetalArmorBody", "Pal Metal Chestplate"),
        ("PalworldPalMetalArmorLegs", "Pal Metal Leggings"),
        ("ChippysWingsInactive", "Chippy's Cloak (Inactive)"),
        ("GothicBathtub", "Gothic Bathtub"),
        ("GothicBed", "Gothic Bed"),
        ("GothicDresser", "Gothic Dresser"),
        ("GothicCandelabra", "Gothic Candelabra"),
        ("GothicCandle", "Gothic Candle"),
        ("GothicChandelier", "Gothic Chandelier"),
        ("GothicChest", "Gothic Chest"),
        ("GothicClock", "Gothic Clock"),
        ("GothicDoor", "Gothic Door"),
        ("GothicLamp", "Gothic Lamp"),
        ("GothicLantern", "Gothic Lantern"),
        ("GothicPiano", "Gothic Piano"),
        ("GothicPlatform", "Gothic Platform"),
        ("GothicSink", "Gothic Sink"),
        ("GothicSofa", "Gothic Sofa"),
        ("Fake_GothicChest", "Trapped Gothic Chest"),
        ("GothicToilet", "Gothic Toilet"),
        ("DemoniteBathtub", "Demonite Bathtub"),
        ("DemoniteBed", "Demonite Bed"),
        ("DemoniteBookcase", "Demonite Bookcase"),
        ("DemoniteDresser", "Demonite Dresser"),
        ("DemoniteCandelabra", "Demonite Candelabra"),
        ("DemoniteCandle", "Demonite Candle"),
        ("DemoniteChair", "Demonite Chair"),
        ("DemoniteChandelier", "Demonite Chandelier"),
        ("DemoniteChest", "Demonite Chest"),
        ("DemoniteClock", "Demonite Clock"),
        ("DemoniteDoor", "Demonite Door"),
        ("DemoniteLamp", "Demonite Lamp"),
        ("DemoniteLantern", "Demonite Lantern"),
        ("DemonitePiano", "Demonite Piano"),
        ("DemonitePlatform", "Demonite Platform"),
        ("DemoniteSink", "Demonite Sink"),
        ("DemoniteSofa", "Demonite Sofa"),
        ("DemoniteTable", "Demonite Table"),
        ("DemoniteWorkbench", "Demonite Work Bench"),
        ("Fake_DemoniteChest", "Trapped Demonite Chest"),
        ("DemoniteToilet", "Demonite Toilet"),
        ("CrimtaneBathtub", "Crimtane Bathtub"),
        ("CrimtaneBed", "Crimtane Bed"),
        ("CrimtaneBookcase", "Crimtane Bookcase"),
        ("CrimtaneDresser", "Crimtane Dresser"),
        ("CrimtaneCandelabra", "Crimtane Candelabra"),
        ("CrimtaneCandle", "Crimtane Candle"),
        ("CrimtaneChair", "Crimtane Chair"),
        ("CrimtaneChandelier", "Crimtane Chandelier"),
        ("CrimtaneChest", "Crimtane Chest"),
        ("CrimtaneClock", "Crimtane Clock"),
        ("CrimtaneDoor", "Crimtane Door"),
        ("CrimtaneLamp", "Crimtane Lamp"),
        ("CrimtaneLantern", "Crimtane Lantern"),
        ("CrimtanePiano", "Crimtane Piano"),
        ("CrimtanePlatform", "Crimtane Platform"),
        ("CrimtaneSink", "Crimtane Sink"),
        ("CrimtaneSofa", "Crimtane Sofa"),
        ("CrimtaneTable", "Crimtane Table"),
        ("CrimtaneWorkbench", "Crimtane Work Bench"),
        ("Fake_CrimtaneChest", "Trapped Crimtane Chest"),
        ("CrimtaneToilet", "Crimtane Toilet"),
        ("SnowBathtub", "Snow Bathtub"),
        ("SnowBed", "Snow Bed"),
        ("SnowBookcase", "Snow Bookcase"),
        ("SnowDresser", "Snow Dresser"),
        ("SnowCandelabra", "Snow Candelabra"),
        ("SnowCandle", "Snow Candle"),
        ("SnowChair", "Snow Chair"),
        ("SnowChandelier", "Snow Chandelier"),
        ("SnowChest", "Snow Chest"),
        ("SnowClock", "Snow Clock"),
        ("SnowDoor", "Snow Door"),
        ("SnowLamp", "Snow Lamp"),
        ("SnowLantern", "Snow Lantern"),
        ("SnowPiano", "Snow Piano"),
        ("SnowPlatform", "Snow Platform"),
        ("SnowSink", "Snow Sink"),
        ("SnowSofa", "Snow Sofa"),
        ("SnowTable", "Snow Table"),
        ("SnowWorkbench", "Snow Work Bench"),
        ("Fake_SnowChest", "Trapped Snow Chest"),
        ("SnowToilet", "Snow Toilet"),
        ("FlinxFurBathtub", "Flinx Fur Bathtub"),
        ("FlinxFurBed", "Flinx Fur Bed"),
        ("FlinxFurBookcase", "Flinx Fur Bookcase"),
        ("FlinxFurDresser", "Flinx Fur Dresser"),
        ("FlinxFurCandelabra", "Flinx Fur Candelabra"),
        ("FlinxFurCandle", "Flinx Fur Candle"),
        ("FlinxFurChair", "Flinx Fur Chair"),
        ("FlinxFurChandelier", "Flinx Fur Chandelier"),
        ("FlinxFurChest", "Flinx Fur Chest"),
        ("FlinxFurClock", "Flinx Fur Clock"),
        ("FlinxFurDoor", "Flinx Fur Door"),
        ("FlinxFurLamp", "Flinx Fur Lamp"),
        ("FlinxFurLantern", "Flinx Fur Lantern"),
        ("FlinxFurPiano", "Flinx Fur Piano"),
        ("FlinxFurPlatform", "Flinx Fur Platform"),
        ("FlinxFurSink", "Flinx Fur Sink"),
        ("FlinxFurSofa", "Flinx Fur Sofa"),
        ("FlinxFurTable", "Flinx Fur Table"),
        ("FlinxFurWorkbench", "Flinx Fur Work Bench"),
        ("Fake_FlinxFurChest", "Trapped Flinx Fur Chest"),
        ("FlinxFurToilet", "Flinx Fur Toilet"),
        ("PineBathtub", "Pine Bathtub"),
        ("PineBed", "Pine Bed"),
        ("PineBookcase", "Pine Bookcase"),
        ("PineDresser", "Pine Dresser"),
        ("PineCandelabra", "Pine Candelabra"),
        ("PineCandle", "Pine Candle"),
        ("PineChandelier", "Pine Chandelier"),
        ("PineChest", "Pine Chest"),
        ("PineClock", "Pine Clock"),
        ("PineLamp", "Pine Lamp"),
        ("PineLantern", "Pine Lantern"),
        ("PinePiano", "Pine Piano"),
        ("PinePlatform", "Pine Platform"),
        ("PineSink", "Pine Sink"),
        ("PineSofa", "Pine Sofa"),
        ("PineWorkbench", "Pine Work Bench"),
        ("Fake_PineChest", "Trapped Pine Chest"),
        ("PineToilet", "Pine Toilet"),
        ("EasterBathtub", "Easter Bathtub"),
        ("EasterBed", "Easter Bed"),
        ("EasterBookcase", "Easter Bookcase"),
        ("EasterDresser", "Easter Dresser"),
        ("EasterCandelabra", "Easter Candelabra"),
        ("EasterCandle", "Easter Candle"),
        ("EasterChair", "Easter Chair"),
        ("EasterChandelier", "Easter Chandelier"),
        ("EasterChest", "Easter Chest"),
        ("EasterClock", "Easter Clock"),
        ("EasterDoor", "Easter Door"),
        ("EasterLamp", "Easter Lamp"),
        ("EasterLantern", "Easter Lantern"),
        ("EasterPiano", "Easter Piano"),
        ("EasterPlatform", "Easter Platform"),
        ("EasterSink", "Easter Sink"),
        ("EasterSofa", "Easter Sofa"),
        ("EasterTable", "Easter Table"),
        ("EasterWorkbench", "Easter Work Bench"),
        ("Fake_EasterChest", "Trapped Easter Chest"),
        ("EasterToilet", "Easter Toilet"),
        ("StoneBathtub", "Stone Bathtub"),
        ("StoneBed", "Stone Bed"),
        ("StoneBookcase", "Stone Bookcase"),
        ("StoneDresser", "Stone Dresser"),
        ("StoneCandelabra", "Stone Candelabra"),
        ("StoneCandle", "Stone Candle"),
        ("StoneChair", "Stone Chair"),
        ("StoneChandelier", "Stone Chandelier"),
        ("StoneChest", "Stone Chest"),
        ("StoneClock", "Stone Clock"),
        ("StoneDoor", "Stone Door"),
        ("StoneLamp", "Stone Lamp"),
        ("StoneLantern", "Stone Lantern"),
        ("StonePiano", "Stone Piano"),
        ("StonePlatform", "Stone Platform"),
        ("StoneSink", "Stone Sink"),
        ("StoneSofa", "Stone Sofa"),
        ("StoneTable", "Stone Table"),
        ("StoneWorkbench", "Stone Work Bench"),
        ("Fake_StoneChest", "Trapped Stone Chest"),
        ("StoneToilet", "Stone Toilet"),
        ("JellyfishBathtub", "Jellyfish Bathtub"),
        ("JellyfishBed", "Jellyfish Bed"),
        ("JellyfishBookcase", "Jellyfish Bookcase"),
        ("JellyfishDresser", "Jellyfish Dresser"),
        ("JellyfishCandelabra", "Jellyfish Candelabra"),
        ("JellyfishCandle", "Jellyfish Candle"),
        ("JellyfishChair", "Jellyfish Chair"),
        ("JellyfishChandelier", "Jellyfish Chandelier"),
        ("JellyfishChest", "Jellyfish Chest"),
        ("JellyfishClock", "Jellyfish Clock"),
        ("JellyfishDoor", "Jellyfish Door"),
        ("JellyfishLamp", "Jellyfish Lamp"),
        ("JellyfishLantern", "Jellyfish Lantern"),
        ("JellyfishPiano", "Jellyfish Piano"),
        ("JellyfishPlatform", "Jellyfish Platform"),
        ("JellyfishSink", "Jellyfish Sink"),
        ("JellyfishSofa", "Jellyfish Sofa"),
        ("JellyfishTable", "Jellyfish Table"),
        ("JellyfishWorkbench", "Jellyfish Work Bench"),
        ("Fake_JellyfishChest", "Trapped Jellyfish Chest"),
        ("JellyfishToilet", "Jellyfish Toilet"),
        ("HallowedBrick", "Hallowed Brick"),
        ("HallowedBrickWall", "Hallowed Brick Wall"),
        ("PineTreeBlockWall", "Pine Tree Wall"),
        ("EasterBlock", "Easter Block"),
        ("EasterBlockWall", "Easter Wall"),
        ("GothicBrick", "Gothic Brick"),
        ("GothicBrickWall", "Gothic Brick Wall"),
        ("FlinxFurBlock", "Flinx Fur Block"),
        ("FlinxFurBlockWall", "Flinx Fur Wall"),
        ("JellyfishBlock", "Jellyfish Block"),
        ("JellyfishBlockWall", "Jellyfish Wall"),
        ("PineWoodBlock", "Pine Wood"),
        ("PineWoodBlockWall", "Pine Wood Wall"),
        ("PaintingRemix", "Remix"),
        ("HarpyBathtub", "Harpy Bathtub"),
        ("HarpyBed", "Harpy Bed"),
        ("HarpyBookcase", "Harpy Bookcase"),
        ("HarpyDresser", "Harpy Dresser"),
        ("HarpyCandelabra", "Harpy Candelabra"),
        ("HarpyCandle", "Harpy Candle"),
        ("HarpyChair", "Harpy Chair"),
        ("HarpyChandelier", "Harpy Chandelier"),
        ("HarpyChest", "Harpy Chest"),
        ("HarpyClock", "Harpy Clock"),
        ("HarpyDoor", "Harpy Door"),
        ("HarpyLamp", "Harpy Lamp"),
        ("HarpyLantern", "Harpy Lantern"),
        ("HarpyPiano", "Harpy Piano"),
        ("HarpyPlatform", "Harpy Platform"),
        ("HarpySink", "Harpy Sink"),
        ("HarpySofa", "Harpy Sofa"),
        ("HarpyTable", "Harpy Table"),
        ("HarpyWorkbench", "Harpy Work Bench"),
        ("Fake_HarpyChest", "Trapped Harpy Chest"),
        ("HarpyToilet", "Harpy Toilet"),
        ("HarpyBlock", "Harpy Block"),
        ("HarpyBlockWall", "Harpy Wall"),
        ("CloudBathtub", "Cloud Bathtub"),
        ("CloudBed", "Cloud Bed"),
        ("CloudBookcase", "Cloud Bookcase"),
        ("CloudDresser", "Cloud Dresser"),
        ("CloudCandelabra", "Cloud Candelabra"),
        ("CloudCandle", "Cloud Candle"),
        ("CloudChair", "Cloud Chair"),
        ("CloudChandelier", "Cloud Chandelier"),
        ("CloudChest", "Cloud Chest"),
        ("CloudClock", "Cloud Clock"),
        ("CloudDoor", "Cloud Door"),
        ("CloudLamp", "Cloud Lamp"),
        ("CloudLantern", "Cloud Lantern"),
        ("CloudPiano", "Cloud Piano"),
        ("CloudSink", "Cloud Sink"),
        ("CloudSofa", "Cloud Sofa"),
        ("CloudTable", "Cloud Table"),
        ("CloudWorkbench", "Cloud Work Bench"),
        ("Fake_CloudChest", "Trapped Cloud Chest"),
        ("CloudToilet", "Cloud Toilet"),
        ("MoonplateBathtub", "Duskware Bathtub"),
        ("MoonplateBed", "Duskware Bed"),
        ("MoonplateBookcase", "Duskware Bookcase"),
        ("MoonplateDresser", "Duskware Dresser"),
        ("MoonplateCandelabra", "Duskware Candelabra"),
        ("MoonplateCandle", "Duskware Candle"),
        ("MoonplateChair", "Duskware Chair"),
        ("MoonplateChandelier", "Duskware Chandelier"),
        ("MoonplateChest", "Duskware Chest"),
        ("MoonplateClock", "Duskware Clock"),
        ("MoonplateDoor", "Duskware Door"),
        ("MoonplateLamp", "Duskware Lamp"),
        ("MoonplateLantern", "Duskware Lantern"),
        ("MoonplatePiano", "Duskware Piano"),
        ("MoonplatePlatform", "Duskware Platform"),
        ("MoonplateSink", "Duskware Sink"),
        ("MoonplateSofa", "Duskware Sofa"),
        ("MoonplateTable", "Duskware Table"),
        ("MoonplateWorkbench", "Duskware Work Bench"),
        ("Fake_MoonplateChest", "Trapped Duskware Chest"),
        ("MoonplateToilet", "Duskware Toilet"),
        ("MoonplateBlock", "Moonplate Block"),
        ("MoonplateBlockWall", "Crescent Wall"),
        ("LibrarianBathtub", "Librarian Bathtub"),
        ("LibrarianBed", "Librarian Bed"),
        ("LibrarianBookcase", "Librarian Bookcase"),
        ("LibrarianDresser", "Librarian Dresser"),
        ("LibrarianCandelabra", "Librarian Candelabra"),
        ("LibrarianCandle", "Librarian Candle"),
        ("LibrarianChair", "Librarian Chair"),
        ("LibrarianChandelier", "Librarian Chandelier"),
        ("LibrarianChest", "Librarian Chest"),
        ("LibrarianClock", "Librarian Clock"),
        ("LibrarianDoor", "Librarian Door"),
        ("LibrarianLamp", "Librarian Lamp"),
        ("LibrarianLantern", "Librarian Lantern"),
        ("LibrarianPiano", "Librarian Piano"),
        ("LibrarianPlatform", "Librarian Platform"),
        ("LibrarianSink", "Librarian Sink"),
        ("LibrarianSofa", "Librarian Sofa"),
        ("LibrarianTable", "Librarian Table"),
        ("LibrarianWorkbench", "Librarian Work Bench"),
        ("Fake_LibrarianChest", "Trapped Librarian Chest"),
        ("LibrarianToilet", "Librarian Toilet"),
        ("LibrarianBlock", "Librarian Block"),
        ("LibrarianBlockWall", "Librarian Wall"),
        ("SpikeBathtub", "Spike Bathtub"),
        ("SpikeBed", "Spike Bed"),
        ("SpikeBookcase", "Spike Bookcase"),
        ("SpikeDresser", "Spike Dresser"),
        ("SpikeCandelabra", "Spike Candelabra"),
        ("SpikeCandle", "Spike Candle"),
        ("SpikeChair", "Spike Chair"),
        ("SpikeChandelier", "Spike Chandelier"),
        ("SpikeChest", "Spike Chest"),
        ("SpikeClock", "Spike Clock"),
        ("SpikeDoor", "Spike Door"),
        ("SpikeLamp", "Spike Lamp"),
        ("SpikeLantern", "Spike Lantern"),
        ("SpikePiano", "Spike Piano"),
        ("SpikePlatform", "Spike Platform"),
        ("SpikeSink", "Spike Sink"),
        ("SpikeSofa", "Spike Sofa"),
        ("SpikeTable", "Spike Table"),
        ("SpikeWorkbench", "Spike Work Bench"),
        ("Fake_SpikeChest", "Trapped Spike Chest"),
        ("SpikeToilet", "Spike Toilet"),
        ("SpikeBlock", "Spike Block"),
        ("SpikeBlockWall", "Spike Wall"),
        ("OfficeBathtub", "Office Bathtub"),
        ("OfficeBed", "Office Bed"),
        ("OfficeBookcase", "Office Bookcase"),
        ("OfficeDresser", "Office Dresser"),
        ("OfficeCandelabra", "Office Candelabra"),
        ("OfficeCandle", "Office Candle"),
        ("OfficeChair", "Office Chair"),
        ("OfficeChandelier", "Office Chandelier"),
        ("OfficeChest", "Office Chest"),
        ("OfficeClock", "Office Clock"),
        ("OfficeDoor", "Office Door"),
        ("OfficeLamp", "Office Lamp"),
        ("OfficeLantern", "Office Lantern"),
        ("OfficePiano", "Office Piano"),
        ("OfficePlatform", "Office Platform"),
        ("OfficeSink", "Office Sink"),
        ("OfficeSofa", "Office Sofa"),
        ("OfficeTable", "Office Table"),
        ("OfficeWorkbench", "Office Work Bench"),
        ("Fake_OfficeChest", "Trapped Office Chest"),
        ("OfficeToilet", "Office Toilet"),
        ("OfficeBlock", "Office Block"),
        ("OfficeBlockWall", "Office Wall"),
        ("ForbiddenBathtub", "Forbidden Bathtub"),
        ("ForbiddenBed", "Forbidden Bed"),
        ("ForbiddenBookcase", "Forbidden Bookcase"),
        ("ForbiddenDresser", "Forbidden Dresser"),
        ("ForbiddenCandelabra", "Forbidden Candelabra"),
        ("ForbiddenCandle", "Forbidden Candle"),
        ("ForbiddenChair", "Forbidden Chair"),
        ("ForbiddenChandelier", "Forbidden Chandelier"),
        ("ForbiddenChest", "Forbidden Chest"),
        ("ForbiddenClock", "Forbidden Clock"),
        ("ForbiddenDoor", "Forbidden Door"),
        ("ForbiddenLamp", "Forbidden Lamp"),
        ("ForbiddenLantern", "Forbidden Lantern"),
        ("ForbiddenPiano", "Forbidden Piano"),
        ("ForbiddenPlatform", "Forbidden Platform"),
        ("ForbiddenSink", "Forbidden Sink"),
        ("ForbiddenSofa", "Forbidden Sofa"),
        ("ForbiddenTable", "Forbidden Table"),
        ("ForbiddenWorkbench", "Forbidden Work Bench"),
        ("Fake_ForbiddenChest", "Trapped Forbidden Chest"),
        ("ForbiddenToilet", "Forbidden Toilet"),
        ("ForbiddenBlock", "Forbidden Block"),
        ("ForbiddenBlockWall", "Forbidden Wall"),
        ("WaterBathtub", "Aquarium Bathtub"),
        ("WaterBed", "Aquarium Bed"),
        ("WaterBookcase", "Aquarium Bookcase"),
        ("WaterDresser", "Aquarium Dresser"),
        ("WaterCandelabra", "Aquarium Candelabra"),
        ("WaterFurnitureCandle", "Aquarium Candle"),
        ("WaterChair", "Aquarium Chair"),
        ("WaterChandelier", "Aquarium Chandelier"),
        ("WaterClock", "Aquarium Clock"),
        ("WaterDoor", "Aquarium Door"),
        ("WaterLamp", "Aquarium Lamp"),
        ("WaterLantern", "Aquarium Lantern"),
        ("WaterPiano", "Aquarium Piano"),
        ("WaterPlatform", "Aquarium Platform"),
        ("WaterSink", "Aquarium Sink"),
        ("WaterSofa", "Aquarium Sofa"),
        ("WaterTable", "Aquarium Table"),
        ("WaterWorkbench", "Aquarium Work Bench"),
        ("WaterToilet", "Aquarium Toilet"),
        ("WaterBlock", "Aquarium Block"),
        ("WaterBlockWall", "Aquarium Wall"),
        ("BoulderBathtub", "Boulder Bathtub"),
        ("BoulderBed", "Boulder Bed"),
        ("BoulderBookcase", "Boulder Bookcase"),
        ("BoulderDresser", "Boulder Dresser"),
        ("BoulderCandelabra", "Boulder Candelabra"),
        ("BoulderCandle", "Boulder Candle"),
        ("BoulderChair", "Boulder Chair"),
        ("BoulderChandelier", "Boulder Chandelier"),
        ("BoulderChest", "Boulder Chest"),
        ("BoulderClock", "Boulder Clock"),
        ("BoulderDoor", "Boulder Door"),
        ("BoulderLamp", "Boulder Lamp"),
        ("BoulderLantern", "Boulder Lantern"),
        ("BoulderPiano", "Boulder Piano"),
        ("BoulderPlatform", "Boulder Platform"),
        ("BoulderSink", "Boulder Sink"),
        ("BoulderSofa", "Boulder Sofa"),
        ("BoulderTable", "Boulder Table"),
        ("BoulderWorkbench", "Boulder Work Bench"),
        ("Fake_BoulderChest", "Trapped Boulder Chest"),
        ("BoulderToilet", "Boulder Toilet"),
        ("BoulderBlock", "Boulder Block"),
        ("BoulderBlockWall", "Boulder Wall"),
        ("DamagingSpikeBlock", "Sharp Spike Block"),
        ("LunasHead", "Luna's Runic Pixie Hood"),
        ("LunasBody", "Luna's Runic Pixie Shirt"),
        ("LunasLegs", "Luna's Runic Pixie Pants"),
        ("LunasWings", "Luna's Runic Pixie Wings"),
        ("LunasCloak", "Luna's Runic Pixie Cloak"),
        ("RemoteControlCar", "Wall Racer Car"),
        ("ToyBreakerBlock", "Toybreaker Brick"),
        ("DemonAltarIcon", "{$ItemName.DemonAltar}"),
        ("CrimsonAltarIcon", "{$ItemName.CrimsonAltar}"),
        ...
        ("PalworldChilletEgg", "Huge Dragon Egg"),
        ("MusicBoxSkeletron", "Music Box (Skeletron)"),
    ]
    .into_boxed_slice()
    .iter()
    .copied()
