...
pub fn get() -> HashMap<&'static str, &'static str> {
    vec![
        ...
        ("DeerclopsIceSpike", "Ice Spike"),
        ("DeerclopsRangedProjectile", "Debris"),
        ("AbigailMinion", "Abigail"),
        ("InsanityShadowFriendly", "Shadow Hand"),
        ("InsanityShadowHostile", "Shadow Hand"),
        ("HoundiusShootius", "Houndius Shootius"),
        ("HoundiusShootiusFireball", "Houndius Shootius"),
        ("PewMaticHornShot", "Pew-Matic Stuff"),
        ("WeatherPainShot", "Hurtnado"),
        ("TentacleSpike", "Tentacle Spike"),
        ("VenomDartTrap", "Venom Dart"),
        ("WandOfFrostingFrost", "Frost"),
        ("Volcano", "Volcano"),
        ("SilverBullet", "Bullet"),
        ("Excalibur", "Excalibur"),
        ...
        ("BladeOfGrass", "Leaf Blade"),
        ("Muramasa", "Muramasa"),
        ("TerraBlade2", "Terra Blade"),
        ("TerraBlade2Shot", "Terra Beam"),
        ("HiveFive", "Hive-Five"),
        ("Trimarang", "Trimarang"),
        ("HorsemanPumpkin", "Pumpkin Head"),
        ...
        ("DeadCellsMushroomBoiMinion", "Mushroom Boi"),
        ("DeadCellsBarrel", "Barrel"),
        ("DeadCellsKillingDeckCard", "Killing Card"),
        ("DeadCellsBarnacle", "Barnacle"),
        ("DeadCellsBarnacleShot", "Barnacle"),
        ("DeadCellsSwarmBiter", "Swarm Worm"),
        ("CobWhip", "Cobwhip"),
        ...
        ("CobWhipSpider", "Tiny Spider"),
        ("MeteorWhipMeteor", "Asteroid"),
        ("FlowerWhipPetal", "Petal Storm"),
        ("ConstellationStar", "Shooting Star"),
        (
            "DeadCellsMushroomBoiMinionExplosion",
            "Mushroom Boi Explosion",
        ),
        ("DeadCellsFlint", "Flint"),
        ("DeadCellsFlintShot", "Flint"),
        ("ShimmerGunStream", "Shimmer Stream"),
        ("DeadCellsFlintSlash", "Flint"),
        ("MoonLordWhipProc", "Possession"),
        ("Pufferfish", "Pufferfish"),
        ("RainbowBoulder", "Rainbow Boulder"),
        ("Poulder", "Poo Boulder"),
        ("MeteorStormMeteor", "Meteor"),
        ("LavaBoulder", "Lava Boulder"),
        ("SpiderBoulder", "Spider Boulder"),
        ("Ghoulder", "Ghoulder"),
        ("BouldyTheBoulder", "Bouldy The Boulder"),
        ("BoulderThatSpawnsPet", "Boulder"),
        ...
        ("TorchGodHelper", "The Torch God"),
        ("PrettyMirror", "Pretty Mirror"),
        ("AcornSlingshotAcorn", "Acorn"),
        ("RainbowGlowstick", "Rainbow Glowstick"),
        ("SuperBomb", "Power Bomb"),
        ("SuperStickyBomb", "Sticky Power Bomb"),
        ("StormLightning", "Lightning"),
        ("LibrarianSkeletonBook", "Book"),
        ("SoundGun", "RHRRRAAAAAAGGHHH!!!"),
        ...
        ("Axearang", "Axearang"),
        ("RainbowBoulderPet", "Rainbow Boulder"),
        ("SlimeSpear", "Slime Spear"),
        ("SlimeWhip", "Slime Whip"),
        ("ObsidianFire", "Obsidian Fire"),
        ("ObsidianFire2", "{$ProjectileName.ObsidianFire}"),
        ("ObsidianFire3", "{$ProjectileName.ObsidianFire}"),
        (
            "SkyDragonsFuryElectrosphere",
            "{$ProjectileName.Electrosphere}",
        ),
    ]
    .into_boxed_slice()
    .iter()
